...
export default function AboutDialog(props: AboutProps) {
    ...
    return (
      ...
      <div className="">
        <div>
          <div className={`absolute h-[50%] top-1/10 inset-x-1/10  bg-white z-6000 rounded-3xl text-start px-5 py-5 transition-all duration-500 ${open ? "opacity-100 visible" : "opacity-0 invisible"}`}>
